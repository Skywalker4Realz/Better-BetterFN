...
async def event_ready() -> None:
    ...
    client.set_avatar(fortnitepy.Avatar(asset=data['avatarskin'], background_colors=['#ffffff', '#ee1064', '#ff0000']))
...
async def event_party_invite(invite):
    if data['joinoninvite'].lower() == 'true':
        try:
            await invite.accept()
            print(Fore.BLUE + ' [+] ' + Fore.RESET + f'Accepted party invite from {invite.sender.display_name}')
        except Exception:
            pass
        ...
        if invite.sender.id in info['FullAccess']:
            await invite.accept()
            print(Fore.BLUE + ' [+] ' + Fore.RESET + 'Accepted party invite from ' + Fore.LIGHTGREEN_EX + f'{invite.sender.display_name}')
        else:
            print(Fore.BLUE + ' [+] ' + Fore.RESET + f'Never accepted party invite from {invite.sender.display_name}')  
            pass
...
async def event_friend_request(request):
    if data['friendaccept'].lower() == 'true':
        try:
            ...
            print(f' [+] Accepted friend request from {request.display_name}' + Fore.LIGHTRED_EX + f' ({lenFriends()})')
        except Exception:
            pass
    ...
    if client.user.display_name != member.display_name:
        try:
            if client.user.id in info['FullAccess']:
                print(Fore.LIGHTGREEN_EX + f' [+] {member.display_name} ' + Fore.RESET + 'joined.')
            else:
                print(f' [+] {member.display_name} joined.' + Fore.LIGHTBLACK_EX + f' ({lenPartyMembers()})')
...
@client.event
async def event_friend_message(message, ctx):
    ...
    if message.content.upper().startswith('CID_'):
        ...
        await message.reply(f'Skin set to: {message.content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        await asyncio.sleep(0.5)
    elif message.content.upper().startswith('BID_'):
        await client.party.me.set_backpack(asset=message.content.upper())
        await message.reply(f'Backpack set to: {message.content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        await asyncio.sleep(0.5)
    elif message.content.upper().startswith('EID_'):
        await client.party.me.set_emote(asset=message.content.upper())
        await message.reply(f'Emote set to: {message.content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif message.content.upper().startswith('PID_'):
        await client.party.me.set_pickaxe(asset=message.content.upper())
        await message.reply(f'Pickaxe set to: {message.content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif message.content.startswith('Playlist_'):
        try:
            await client.party.set_playlist(playlist=message.content)
            await message.reply(f'Playlist set to: {message.content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except fortnitepy.Forbidden:
            await message.reply(f"I can not set gamemode because I am not party leader. | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
    elif message.content.lower().startswith('prefix'):
        await message.reply(f'Current prefix: {prefix} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
 

@client.event
async def event_command_error(ctx, error):
    if isinstance(error, commands.CommandNotFound):
        await ctx.send(f'That is not a command. Try {prefix}help | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif isinstance(error, IndexError):
        pass
    elif isinstance(error, fortnitepy.HTTPException):
        pass
    elif isinstance(error, commands.CheckFailure):
        await ctx.send("You don't have access to that command. | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
    elif isinstance(error, TimeoutError):
        await ctx.send("You took too long to respond! | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
    else:
        print(error)
...
async def skin(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No skin was given, try: {prefix}skin (skin name) | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.upper().startswith('CID_'):
        await client.party.me.set_outfit(asset=content.upper())
        await ctx.send(f'Skin set to: {content} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            ...
            await ctx.send(f'Skin set to: {cosmetic.name} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            await asyncio.sleep(0.5)
            await ctx.send("discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
            await ctx.send("discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a skin named: {content} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')


@client.command()
async def backpack(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No backpack was given, try: {prefix}backpack (backpack name) | https://discord.gg/fQB9jju |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
        await asyncio.sleep(10.5)
        await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
    elif content.lower() == 'none':
        await client.party.me.clear_backpack()
        await ctx.send('Backpack set to: None | https://discord.gg/fQB9jju |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.upper().startswith('BID_'):
        await client.party.me.set_backpack(asset=content.upper())
        await ctx.send(f'Backpack set to: {content} | https://discord.gg/fQB9jju |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
        await asyncio.sleep(10.5)
        await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT | lobby bot by svaxyy lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy  | ")
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Backpack set to: {cosmetic.name} | https://discord.gg/fQB9jju |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a backpack named: {content} | https://discord.gg/fQB9jju |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
            await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
            await asyncio.sleep(10.5)
            await ctx.send("JOIN https://discord.gg/fQB9jju FOR YOUR OWN LOBBY BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
...
async def emote(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No emote was given, try: {prefix}emote (emote name) | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.lower() == 'floss':
        await client.party.me.clear_emote()
        await client.party.me.set_emote(asset='EID_Floss | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        await ctx.send(f'Emote set to: Floss | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.lower() == 'none':
        await client.party.me.clear_emote()
        await ctx.send(f'Emote set to: None | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.upper().startswith('EID_'):
        await client.party.me.clear_emote()
        await client.party.me.set_emote(asset=content.upper())
        await ctx.send(f'Emote set to: {content} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        await asyncio.sleep(0.5)
        await ctx.send("discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
    else:
        try:
            ...
            await ctx.send(f'Emote set to: {cosmetic.name} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            await asyncio.sleep(0.5)
            await ctx.send("discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
            await asyncio.sleep(0.5)
            await ctx.send("discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find an emote named: {content} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')


@client.command()
async def pickaxe(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No pickaxe was given, try: {prefix}pickaxe (pickaxe name) | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.upper().startswith('Pickaxe_'):
        await client.party.me.set_pickaxe(asset=content.upper())
        await ctx.send(f'Pickaxe set to: {content} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Pickaxe set to: {cosmetic.name} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a pickaxe named: {content} | discord.gg/fQB9jju FOR YOUR OWN BOT |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')


@client.command()
async def pet(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No pet was given, try: {prefix}pet (pet name) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.lower() == 'none':
        await client.party.me.clear_pet()
        await ctx.send('Pet set to: None | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Pet set to: {cosmetic.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a pet named: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')


@client.command()
async def emoji(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No emoji was given, try: {prefix}emoji (emoji name) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    try:
        cosmetic = await BenBotAsync.get_cosmetic(
            lang="en",
            searchLang="en",
        ...
        await ctx.send(f'Emoji set to: {cosmetic.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    except BenBotAsync.exceptions.NotFound:
        await ctx.send(f'Could not find an emoji named: {content} | JOIN discord.gg/fQB9jju FOR YOUR OWN BOT  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def current(ctx, setting = None):
    if setting is None:
        await ctx.send(f"Missing argument. Try: {prefix}current (skin, backpack, emote, pickaxe, banner) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
        ...
        try:
            ...
            await ctx.send(f"My current {setting} is: {cosmetic.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f"I couldn't find a {setting} name for that. | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
...
async def name(ctx, *, content=None):
    if content is None:
        await ctx.send(f'No ID was given, try: {prefix}name (cosmetic ID) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic_from_id(
                cosmetic_id=content
            )
            await ctx.send(f'The name for that ID is: {cosmetic.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            print(f' [+] The name for {cosmetic.id} is: {cosmetic.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a cosmetic name for ID: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  |  ')
...
async def cid(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No skin was given, try: {prefix}cid (skin name) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'The CID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            print(f' [+] The CID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a skin named: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def bid(ctx, *, content):
    if content is None:
        await ctx.send(f'No backpack was given, try: {prefix}bid (backpack name) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'The BID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            print(f' [+] The BID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a backpack named: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def eid(ctx, *, content):
    if content is None:
        await ctx.send(f'No emote was given, try: {prefix}eid (emote name) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    elif content.lower() == 'floss':
        ...
        try:
            ...
            await ctx.send(f'The EID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            print(f' [+] The EID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find an emote named: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def pid(ctx, *, content):
    if content is None:
        await ctx.send(f'No pickaxe was given, try: {prefix}pid (pickaxe name) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'The PID for {cosmetic.name} is: {cosmetic.id} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            print(f' [+] The PID for {cosmetic.name} is: {cosmetic.id}')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a pickaxe named: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def random(ctx, content = None):
    ...
    if content is None:
        ...
        if content.lower() == 'skin':
            ...
            await ctx.send(f'Skin randomly set to: {skin.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')

        elif content.lower() == 'backpack':
            await client.party.me.set_backpack(asset=backpack.id)
            await ctx.send(f'Backpack randomly set to: {backpack.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')

        elif content.lower() == 'emote':
            await client.party.me.set_emote(asset=emote.id)
            await ctx.send(f'Emote randomly set to: {emote.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')

        elif content.lower() == 'pickaxe':
            await client.party.me.set_pickaxe(asset=pickaxe.id)
            await ctx.send(f'Pickaxe randomly set to: {pickaxe.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
    ...
    if content is None:
        ...
        if content.upper().startswith('Pickaxe_'):
            ...
            try:
                ...
                await client.party.me.clear_emote()
                await client.party.me.set_emote(asset='EID_IceKing')
                await ctx.send(f'Pointing with: {cosmetic.name} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            except BenBotAsync.exceptions.NotFound:
                await ctx.send(f'Could not find a pickaxe named: {content} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def checkeredrenegade(ctx):
    ...
    await ctx.send('Skin set to: Checkered Renegade | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def pinkghoul(ctx):
    ...
    await ctx.send('Skin set to: Pink Ghoul Trooper | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def purpleskull(ctx):
    ...
    await ctx.send('Skin set to: Purple Skull Trooper | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def purpleportal(ctx):
    ...
    await ctx.send('Backpack set to: Purple Ghost Portal | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def goldpeely(ctx):
    ...
    await ctx.send('Skin set to: Golden Peely | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def hatlessrecon(ctx):
    ...
    await ctx.send('Skin set to: Hatless Recon Expert | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def hologram(ctx):
    ...
    await ctx.send("Skin set to: Hologram | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
...
async def itemshop(ctx):
    ...
    await ctx.send("Equipping all item shop skins + emotes | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
    ...
    await ctx.send("Done! | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ")
...
async def new(ctx, content = None):
    ...
    if content is None:
        await ctx.send(f'There are {len(newSkins) + len(newEmotes)} new skins + emotes | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def unready(ctx):
    ...
    await ctx.send('Unready! | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def sitin(ctx):
    await client.party.me.set_ready(fortnitepy.ReadyState.NOT_READY)
    await ctx.send('Sitting in | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
async def banner(ctx, args1 = None, args2 = None):
    if (args1 is not None) and (args2 is None):
        if args1.startswith('defaultcolor'):
            ...
            await ctx.send(f'Banner color set to: {args1} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            ...
            await ctx.send(f'Banner color set to: defaultcolor{args1} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            ...
            await ctx.send(f'Banner Icon set to: {args1} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
        ...
        if args2.startswith('defaultcolor'):
            ...
            await ctx.send(f'Banner icon set to: {args1} -- Banner color set to: {args2} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
            ...
            await ctx.send(f'Banner icon set to: {args1} -- Banner color set to: defaultcolor{args2} | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')

        else:
            await ctx.send(f'Not proper format. Try: {prefix}banner (Banner ID) (Banner Color ID) | https://discord.gg/fQB9jju  |    lobby bot by svaxyy | 24/7 bot 1. bot by svaxyy |  | ')
...
@client.event
async def event_party_member_join(member, ctx):
    if client.user.display_name != member.display_name:
        try:
            if client.user.id in info['FullAccess']:
                print(Fore.LIGHTGREEN_EX + f' [+] {member.display_name} ' + Fore.RESET + 'joined.')
